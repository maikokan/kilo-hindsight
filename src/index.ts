...
// but the module is loaded once per Kilo server process).
...
const HindsightPlugin: Plugin = async (input: PluginInput, options?: Record<string, unknown>) => {
...
// Default export is the Plugin function itself — Kilo's loader calls the
